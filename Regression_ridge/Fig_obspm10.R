...
#=========================================================================#
Fig_obspm10 = function(obs,prev,titlemain,ThrLow=50,ThrHigh=80,FileName=NULL) {
    ...
    main = titlemain, cex=1.5, cex.lab=1.2, cex.main = 1.4,
    cex.axis=1.2)
    abline(0,1,h=c(ThrLow,ThrHigh),v=c(ThrLow,ThrHigh),col=2,lwd=2) 
